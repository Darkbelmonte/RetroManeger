        ...
        if os.path.isfile(str(caminho_arquivo)) == True:
            ...
            for linha in arquivo:
                ...
                if Criterio in linha == 'xcopy ':
                    Valor_Criterio = linha.replace('\n', '')
                    return Nome + ':' + Valor_Criterio
                if Criterio in linha == 'copy /y ':
                    return Nome + ':' + Valor_Criterio
                if Criterio in linha == '=':
                    return Nome + ':' + Valor_Criterio
                elif Criterio in linha != 'xcopy ' or Criterio in linha != 'copy ' or Criterio in linha != '=' or Criterio in linha != '#':
