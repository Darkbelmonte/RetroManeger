...
for path, folders, files in tqdm(os.walk(currentdir, topdown=False), desc =" - Verificação Renomeando Arquivos"):
                    ...
                    if elemento == folder:
                        ...
                        for official_indice, official_elemento in enumerate(df['official_name']):
                            if elemento == folder and indice == official_indice:
                                ...
                                #print(f'index {indice} = {old_file}  >> index = {official_indice} | {new_file}')
